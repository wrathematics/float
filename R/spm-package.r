...
#' @import methods
#' 
#' @useDynLib float R_mat2spm R_spm2mat R_crossprod_spm R_crossprod_spmspm
...
#'   R_numbytes_spm R_init_NA R_flrunif_spm R_flrnorm_spm R_exp_spm R_expm1_spm
...
#'   R_isinfinite_spm R_isnan_spm R_gamma_spm R_lgamma_spm R_isna_spm
#'   R_naomit_spm R_add_spm R_mul_spm R_sub_spm R_div_spm R_pow_spm
#'   R_colSums_spm R_rowSums_spm R_colMeans_spm R_rowMeans_spm R_norm_spm
#'   R_rcond_spm R_lt_spm R_le_spm R_eq_spm R_gt_spm R_ge_spm R_sum_spm
...
#'   R_bracketchecks_spm R_machine_spm R_backsolve_spm
#' 
#' @docType package
#' @name spm-package
#' @author Drew Schmidt
