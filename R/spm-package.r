...
#'   R_nrow_spm R_ncol_spm R_dim_spm R_length_spm R_isSymmetric_spm R_svd_spm
#'   R_isavec_spm R_qr_spm R_qrQ_spm R_qrR_spm R_numbytes_spm R_init_NA
...
#'   R_ge_spm R_sum_spm R_min_spm R_max_spm R_c_spm R_sweep_spm
#' 
#' @docType package
#' @name spm-package
#' @author Drew Schmidt
